...
export default function ToolPage() {
  return (
    <PageShell className="py-8 sm:py-12 lg:py-16">
      ...
      <SimpleToolForm endpoint="/api/pdf/compress" accept="application/pdf,.pdf" title="Kompres PDF" description="Perkecil ukuran PDF agar lebih mudah diupload ke email, Google Form, website kampus, lamaran kerja, atau sistem administrasi." buttonLabel="Kompres PDF" outputLabel="PDF lebih kecil" />
    </PageShell>
  );
}
