    ...
    <section className="rounded-[18px] border border-slate-200 bg-white p-5 sm:p-7">
      ...
      <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_1.15fr]">
        ...
        <div className="rounded-[14px] border border-emerald-200 bg-emerald-50 p-5">
          <p className="font-mono text-xs uppercase tracking-[0.18em] text-emerald-700">Estimasi Penghematan</p>
          <p className="mt-3 text-sm leading-6 text-emerald-900">Dengan mencetak halaman hitam putih sebagai grayscale, Anda dapat menghemat biaya print hingga</p>
          <p className="mt-3 text-3xl font-semibold tracking-[-0.03em] text-emerald-700">70% - 85%</p>
        </div>
      </div>
