...
export function SiteFooter() {
  return (
    <footer className="mt-20 border-t border-slate-200 dark:border-brand-line bg-brand-paper dark:bg-brand-night text-brand-ink dark:text-slate-100">
      <Container className="py-12">
        <div className="grid gap-10 md:grid-cols-[1fr_auto_auto] md:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-md text-sm leading-7 text-slate-600 dark:text-slate-400">Ruang kecil untuk membangun tools web, mencatat proses, dan mengubah masalah sehari-hari menjadi produk sederhana yang bisa dipakai.</p>
          </div>
          <div>
            <h3 className="font-mono text-xs uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">Navigasi</h3>
          ...
          <div>
            <h3 className="font-mono text-xs uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">Kontak</h3>
            <div className="mt-4 grid gap-3 text-sm text-slate-700 dark:text-slate-300">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-slate-200 dark:border-brand-line pt-6 text-xs text-slate-600 dark:text-slate-400 sm:flex-row sm:items-center sm:justify-between">
